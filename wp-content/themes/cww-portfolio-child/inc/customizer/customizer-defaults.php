...
if (!function_exists('cww_portfolio_customizer_defaults')):
	function cww_portfolio_customizer_defaults()
	{
		...
		$defaults['cww_card_trick_title'] = esc_html__('Card Trick', 'cww-portfolio');
		$defaults['cww_card_trick_sub_title'] = '';
		$defaults['cww_card_trick_post'] = 0;

		$defaults['cww_service_enable'] = 1;
		$defaults['cww_portfolio_enable'] = 1;
		$defaults['cww_card_trick_enable'] = 1;
