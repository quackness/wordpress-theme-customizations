			...
			<div class="container">
				...
				<div class="cotent-wrapp-banner cww-flex">
					...
					<div class="content-wrapp">
						<h5>
							<?php echo esc_html($cww_banner_text_sm); ?>
						</h5>
						<h2>
							<?php echo esc_html($cww_banner_text_lg); ?>
						</h2>
						<p>
							<?php echo esc_html($cww_banner_text_sm2); ?>
						</p>
						...
						<div class="button-wrapp cww-flex">
							<div class="btn-primary">
								<a href="<?php echo esc_url($cww_banner_btn_url) ?>">
									<span>
										<?php echo esc_html($cww_banner_btn_text); ?>
									</span>
								</a>
							</div>
							<div class="btn-secondary">
								<a href="<?php echo esc_url($cww_banner_btn_url_sec) ?>" class="cww-flex">
									<span>
										<?php echo esc_html($cww_banner_btn_text_sec); ?>
									</span>
				...
				<div class="bottom-style">
					...
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400.6 1226.4"
						enable-background="new 0 0 1400.6 1226.4">
		...
		<section id="cww-service-section" class="cww-service-section">
			<div class="container">
				<div class="service-title-wrapper">
					<div class="section-title-wrapp">
						<h3>
							<?php echo esc_html($cww_service_title); ?>
						</h3>
						<p>
							<?php echo esc_html($cww_service_sub_title); ?>
						</p>
					</div>
				</div>
		...
		<section id="cww-portfolio-section" class="cww-portfolio-section gallery">
			<div class="container">
				<div class="section-titles-wrapper">
					<div class="section-title-wrapp">
						<h3>
							<?php echo esc_html($cww_portfolio_title); ?>
						</h3>
						<p>
							<?php echo esc_html($cww_portfolio_sub_title); ?>
						</p>
					</div>
				</div>
				<?php
...
if (!function_exists('cww_portfolio_cta')):
	function cww_portfolio_cta()
	{
		...
		<section id="cww-cta-section" class="cww-cta-section" style="background-image:url(<?php echo esc_url($cww_cta_bg) ?>)">
			<div class="container">
				<h3>
					<?php echo esc_html($cww_cta_title); ?>
				</h3>
				<div class="subtitle">
					<?php echo esc_html($cww_cta_sub_title); ?>
				</div>
		...
		<section id="cww-blog-section" class="cww-blog-section">
			<div class="container">
				<div class="section-titles-wrapper">
					<div class="section-title-wrapp">
						<h3>
							<?php echo esc_html($cww_blog_title); ?>
						</h3>
						<p>
							<?php echo esc_html($cww_blog_sub_title); ?>
						</p>
					</div>
				</div>
		...
		<section id="cww-contact-section" class="cww-contact-section">
			<div class="container">
				<div class="section-titles-wrapper">
					<div class="section-title-wrapp">
						<h3>
							<?php echo esc_html($cww_contact_title); ?>
						</h3>
						<p>
							<?php echo esc_html($cww_contact_sub_title); ?>
						</p>
					</div>
				</div>
				...
				<div class="contact-wrapp cww-flex">
					...
					<div class="address-wrap">
						...
						<p>
							<?php echo esc_html($cww_contact_info_sub_title); ?>
						</p>
